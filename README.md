...
> My First React App. "Math magicians" is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to:
...
Feel free to check the [issues page](https://github.com/AngomRanjan/math-magician/issues).

## Show your support

Give a [⭐️](https://github.com/AngomRanjan/math-magician/stargazers) if you like this project!
